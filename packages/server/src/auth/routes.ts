...
import { verifyEmailHandler, verifyEmailValidator, verifyEmailHandlerCustom } from './verifyemail';
...
authRouter.get('/verify-email/:id/:secret', asyncWrap(verifyEmailHandlerCustom));
